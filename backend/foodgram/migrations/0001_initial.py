    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement_unit', models.TextField(unique=True, verbose_name='Единица измерения')),
            ],
            options={
                'ordering': ('-id',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', to='foodgram.ingredients', verbose_name='Ингредиент')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('#ff0006', 'Красный'), ('#879eee', 'Голубой'), ('#220e75', 'Синий'), ('#e784f4', 'Розовый'), ('#8fd8b9', 'Светло зелёный'), ('#faad62', 'Светло оранжевый'), ('#deec59', 'Жёлтый'), ('#7e4bf3', 'Фиолетовый')], default='#ffffff', max_length=7, unique=True, verbose_name='Цвет')),
            ],
            options={
                'verbose_name': 'Тег',
